...
enum InheritanceTestFile: TestFile {
    ...
    private static func validatePointClass(classDecl: ClassDecl) throws {
        #expect(classDecl.name.value == "Point")
        ...
        #expect(initMethod.name.value == "init")
        try #require(initMethod.parameters.parameters.count == 2)
        #expect(initMethod.parameters.parameters[0].name.value == "x_val")
        #expect(initMethod.parameters.parameters[0].type.description == "Int")
        #expect(initMethod.parameters.parameters[1].name.value == "y_val")
    ...
    private static func validatePoint3DClass(classDecl: ClassDecl) throws {
        #expect(classDecl.name.value == "Point3D")
        #expect(classDecl.inheritance != nil)
        ...
        #expect(init3DMethod.name.value == "init3D")
        try #require(init3DMethod.parameters.parameters.count == 3)
        #expect(init3DMethod.parameters.parameters[0].name.value == "x_val")
        #expect(init3DMethod.parameters.parameters[1].name.value == "y_val")
        #expect(init3DMethod.parameters.parameters[2].name.value == "z_val")
